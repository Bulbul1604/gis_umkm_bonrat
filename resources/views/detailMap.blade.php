...
<body>
    ...
    <section class="about my-5 container" id="about" style="background-color: #ffffff;">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">{{ ucwords($umkm->kelompokUsaha->kel_usaha) }} - {{ ucwords($umkm->jenis_usaha) }}
                </p>
    ...
    <script>
        ...
        marker.bindPopup(
            `<a href="{{ route('detail-map-rute', $umkm->id) }}" class="text-success" style="text-decoration: none">Tampilkan Rute <i class="fw-bold bi bi-arrow-right-short"></i></a>`
        ).openPopup();
    </script>
</body>
